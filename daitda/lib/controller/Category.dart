...
class Category extends GetxController {
  ...
  Category() {
    ...
    categoryMember.add(CategoryMember(
        ...
        subtitle: "subtitle",
        body:
            '"전국 소년소녀 가정 수는 17명, 보건복지부의 통계에 따르면 2019년 전국 소년소녀 가정은 17명에 불과합니다."\n이는 많은 소년소녀 가정이 가정위탁 아동으로 변하고 있기 때문입니다.\n2019년 소년소녀 가정에서 전환된 가정위탁 보호아동은 389명에 달합니다.\n\n그러나 가정위탁을 위한 부모들의 숫자는 매번 부족하기만 합니다.\n친부모의 학대,사망등으로 안전한 울타리를 잃은 아이들이 안락한 가정에서\n자라날 수 있도록 많은 관심이 필요합니다.\n\n아이들에게 든든한 울타리를 지어줄 수 있도록 당신의 시간을 나누어주세요.',
