...
class CategoryService {
  String indexToCategory(int index) {
    switch (index) {
      case 0:
        return "한부모 가정 ∙ 조손 가정";
        break;
